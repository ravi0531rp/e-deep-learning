...
my_parser.add_argument("-c", "--content_image", type=str, required=True)
my_parser.add_argument("-s", "--style_image", type=str, required=True)
...
content_img = get_image(content_img, img_transform)
style_img = get_image(style_img, img_transform)
